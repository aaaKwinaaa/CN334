...
<div class="container">
    <div class="row justify-content-around">
        <div class="container-xl">
            <div class="row">
                <div class="col">
                    <h2 ><b class=" text-white "> PROFILE Restaurant</b> </h2>

                    <div class="card p-3 mt-5 d-flex justify-content-center" style="width: 700px; height:200px;">
                        <div class="d-flex align-items-center">
                            ...
                            {{-- <button type="submit" class="btn btn-info" value="Delete">
                                ...
                                <!-- Modal -->
                                <form method="POST" action="{{ route('restaurant.profile.update',$profile->id) }}"  enctype="multipart/form-data">
